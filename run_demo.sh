...
read -n1 -r -p "Press any key to continue."
../PBassign.py -f 3ICH.pdb -o 3ICH --phipsi
...
read -n1 -r -p "Press any key to continue."
../PBassign.py -f 2LFU.pdb -o 2LFU --flat


echo  -e "\n"
echo "#------------------------------------------------------------------------#"
echo "|                                                                        |"
echo "|  Protein Blocks assignation: static structures -d option               |"
echo "|                                                                        |"
echo "#------------------------------------------------------------------------#"


echo  -e "\n"
echo "Test with all pdb file in a directory"
